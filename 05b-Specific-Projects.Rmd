...
With position control data, the number of monthly roles (that are budgeted for) can be seen (by row), and when filtering for employee_number = 0, the number of monthly vacancies can be calculated. The number of vacancies equals the number of rows of employee_number = 0. This data can be filtered by campus and region and employee_id.
...
Month     Number_Vacancies    Total_Number_Positions    Vacancy_Rate  Mean Vacancy_Rate_All_Months  Mean_Vacancy_Rate_Exclude_July
July	      568	                4179	                        0.14		        0.07                           0.06
August	    316	                4143	                        0.08		        0.07                           0.06
September	  306	                4143	                        0.07		        0.07                           0.06
October	    273	                4125	                        0.07		        0.07                           0.06
November	  258	                4120	                        0.06		        0.07                           0.06
December	  244	                4120	                        0.06		        0.07                           0.06
January	    252	                4121	                        0.06		        0.07                           0.06
February	  258	                4124	                        0.06		        0.07                           0.06
March	      235	                4116	                        0.06		        0.07                           0.06
April	      209	                4105	                        0.05		        0.07                           0.06
May	        210	                4088	                        0.05		        0.07                           0.06
