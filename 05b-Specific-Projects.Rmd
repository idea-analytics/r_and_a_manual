...
Although there is some expected correlation between student demographics, there is poor association between Jobvite vacancy rates and STAAR Performance. The Correlation Between Jobvite Vacancies and STAAR Performance is Poor at -0.10 (Not Inclusive of All Vacancies in Position Control data). Some roles show as a “vacancy” in position control data because they are never filled for SY 23-24. However, we do not attempt to fill all roles that have a position control number assigned.This alters the true vacancy rate, which should be openings that remain unfilled even after we wish them to be filled and/or attempt to fill them. Poor correlation and predictive power between Position Control vacancy rates and STAAR performance, possibly indicating that we may want to examine other factors that could impact STAAR performance. Investigate other modeling methods for this type of data and research question.

#### Recommendations.

It is most useful when all data systems align and data within systems is easily matched. It may prove useful to identify other potential sources of poor STAAR performance in SY 23-24. Answer these questions: 1) How long are vacancies at IDEA for teacher roles? 2) How many vacancies are at IDEA for teacher roles? 3) Which specific grade and course/subject are the vacancies in? 4) What is the highest number of vacancies, during a single time-period? 
(Time-period = Semester, Quarter, Month, Week); 5) Which specific grade and course/subject is the employee currently teaching?

### Continuous Enrollment
This project looked at the impacts of enrollment type on student academic achievement. Enrollment is defined as continuous or not continuous. Continuous enrollment was year-over-year enrollment of students at IDEA from the initial year of enrollment, to the final year of enrollment. If the student is still presently enrolled, the final year of enrollment was SY 2023-2024 because those are the student assessment scores and data we had access to. Non-continuous enrollment was having at least one-year of a gap in enrollment at IDEA, from the initial year of enrollment to the final year of enrollment (after the student returned to IDEA Public Schools). Student achievement was examined in the form of  external assessments, such as STAAR, RenSTAAR, AP Exams, and internal exams including finals and EOY, MOY, and BOY assessments. 
