...
* **Educate our partners**: Assist our team and family in understanding what is and what is not possible with data, that is what analyses can be performed, what nuggets of wisdom can be mined, and where we face limitation and need to bring substantive expertise from outside R&A.   
...
His previous position was with the Software Development Team as a Senior Developer working on data integration and software development. One of the software’s led by Edison was Teacher Career Pathway (TCP) in which he developed and designed the system to absorb numerous data points to be transformed into a TCP Level for all teacher across IDEA.
...
### Chris Haid 
Chris Haid is the Sr. VP of Data Analytics at IDEA Public Schools, where leads research, evaluation, and data analysis across 180+ schools in Texas, Louisiana, Florida, and Ohio.
...
### Mishan Jensen, PhD
Dr. Mishan Jensen is Director of Analytics on IDEA’s Research and Analytics Team with 4 years of experience in program evaluation in a large urban school district and 4 years of experience as a Statistician for the Texas Department of Public Safety & at IDEA. She holds Master's and Doctoral degrees from the University of Texas at Austin in educational psychology, with a specialization in Quantitative Methods. Previous work included evaluating multilingual education, teacher appraisal programs, and integration of arts into the classroom. During her time at UT, Mishan assisted with the development of the College of Education’s first fully web-based Introduction to Statistics course, as well as provided assistant teaching support for most of the graduate level statistics courses offered. Recent work at IDEA has included Student Persistence, Enrollment, Teacher Career Pathways, Teacher Incentive Allotment, and Advanced Placement, focusing on impact analyses and predictive modeling.


### Steven Macapagal
Steven Macapagal (Mac) is an Analytics Manager with IDEA Public Schools on the Research, Analytics, and Product team and was previously a Sr. Data Scientist. Prior to joining the team, he taught middle school and high school math, including AP and IB courses, and was a grade team leader at IDEA Bluff Springs College Preparatory and IDEA Frontier College Preparatory. He started as a Teach For America - Rio Grande Valley corps member at IDEA Frontier and saw 100 percent of his seniors matriculate to college. Mac earned his BA in Economics and Mathematics at The University of Texas at Austin and his MS in Statistics at Texas A&M University. His current work involves academic and operational data science projects and leading Data Fellows, a professional development program for data science and analysis.


### Aline Orr, PhD
Dr. Aline Orr has over 20 years of combined experience in research and program evaluation. She holds a Master's degree in educational psychology and quantitative methods from the University of Texas at Austin and a PhD in Neuroscience from the University of Pittsburgh, where she focused on brain pathways underlying emotional responses. In the recent past, Aline has led the evaluation of educational programs serving elementary and secondary students in a large urban public school district. Before that she was conducting educational research for a large assessment and textbook publishing house. Aline joined IDEA's Research and Analytics team as an evaluator in 2021 and is currently the Director of Research. In this position, she partners with the Advancement and Growth teams as well as the Operations team to implement research and insights that drive change and improvements.


### Ilissa Madrigal
Ilissa Madrigal is an Sr. Evaluator on the R&A team, often assisting with qualitative methods and frequently partnering with HA and AST teams. 
...
### Lindsey Smith, PhD
Dr. Lindsey Smith is a data scientist at IDEA Public Schools where she contributes to the mission and goals of IDEA by providing analyses and reporting. Prior to coming to IDEA, she was an associate professor of instruction at The University of Texas at Austin in the Department of Statistics and Data Science. Lindsey holds a BS in Biochemistry, MS in Statistics, and PhD in Educational Psychology with a focus in Quantitative Methods from The University of Texas at Austin.
...
### Connor Caldwell
Connor Caldwell is a statistician on the R&A Team who supports the Human Assets division. She holds a BA in Statistics and Cognitive Science from Rice University and a MS in Information Science at Texas A&M International University.


### Jose F. Rodriguez
Jose Rodriguez is a Human Assets Data Analyst at IDEA with a background in statistics. He supports IDEA's goals by transforming information into insights that drive staff performance management and reward programs.


### Colleen Skinner
Colleen Skinner is a Human Assets Data Analyst on the R&A Team at IDEA. She earned a BA in Statistics and Data Science from Rice University. 

### Hilary Doe
Hilary Doe is a Data Analyst supporting IDEA’s Growth team. Before joining IDEA in August 2025, Hilary worked as a Senior Data Analyst at the Prenatal-to-3 Policy Impact Center at Vanderbilt University (formerly the Child and Family Research Partnership at UT Austin). In that role she managed, merged, cleaned, and analyzed large datasets primarily for program evaluation research for programs serving young children and their families. Hilary received her PhD in Applied Developmental Psychology from the University of Pittsburgh in 2017 and has a BA in Psychology from Messiah College. 
...
It includes a simple interactive ggplot graph ([made interactive by the most excellent `{ggiraph}` package ](https://davidgohel.github.io/ggiraph/)) as a well as a table with some more info about about each merged pull request. 

Note that clicking on the hyperlinked pull request number will take you to the diff page on Github for the merged pull request. 
