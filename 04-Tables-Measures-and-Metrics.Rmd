...
-   **ETHNICITY:** The Race/Ethnicity in mutually exclusive categories, however, More than 2 Races is not an option
-   **TENURE:** The number of year the employee has worked at IDEA
-   **EMPLOYEESTATUS:** 0 == No Longer Employeed (NLE), 1 == Active
-   **EXITREASON:** Termination Reason
-   **EXITDESCRIPTION:** Longer description of reason
-   **MANAGER:** Employee's Manager
-   **CHIEF:** The abbreviated chief (Cso)
...
There are more columns in this table that could be useful, for example there are columns that indicate if the employee is a First Year Teacher or a leaver within the first 90 days of employment.
...
The following R code is an example of calculating All Staff Retention by Entity using TRUELEAVER and TRUEHEADCOUNT:
