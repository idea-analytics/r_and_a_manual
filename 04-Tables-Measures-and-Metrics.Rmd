...
For Prior Year's Data there are other tables with the same columns as above

**2018-2019** **Table** [RGVPDSD-DWPRD1].[Staffing].[dbo].[StaffHeadCountNew1819] **2019-2020** **Table** [RGVPDSD-DWPRD1].[Staffing].[dbo].[StaffHeadCountNew1920] **2020-2021** **Table** [RGVPDSD-DWPRD1].[Staffing].[dbo].[StaffHeadCountNew2021] **2021-2022** **Table** [RGVPDSD-DWPRD1].[Staffing].[dbo].[StaffHeadCountNew2122]

Data has varied across the years and the naming conventions (or lack there of) is varied across these tables.

The data that feeds the Staff Retention Dashboard is found in a different table that contains the current year and the prior year's data.

**Table:** [RGVPDSD-DWPRD1].[Staffing].[Reporting].[Employees] This table contains the current year's staff retention data and the prior year.
...
90 Day retention is the attrition rate of first year staff. The formula for the attrition rate is 1-(number of first year staff who left prior to reaching 90 days after their start date/ total number of first year staff).

In the staff retention dashboard (reporting.employees), there is a binary column "LEAVERS90D" that is 1 if that staff member left within 90 calendar days of their start date and 0 otherwise. To calculate 90D retention, it divides the number of 0's in that column by the total count of first year staff.

**Example:** + Total staff headcount: 10 + 1 staff member is actively employed but is only 45 calendar days from their start date (staff member 1) + 1 staff member is no longer employed and quit 60 calendar days after their start date (staff member 2) + 1 staff member is no longer employed and quit more than 90 calendar days after their start date + 7 staff members are actively employed and more than 90 calendar days from their start date

In this example, 90D retention would be 1-(1/10) = 90%. If staff member 1 remains employed through their first 90 calendar days of employment, this rate would remain unchanged. If staff member 1 were to leave prior to their 91st day of employment, this rate would change to 1-(2/10) = 80%.

### Tips for Staff Retention Reporting

When calculating year over year retention using reporting.employees, two columns, TRUELEAVER and TRUEHEADCOUNT, need to be created to get the proper retention for the previous year. These columns can be created as follows (from SY 22-23 and SY 23-24; years can be changed as necessary):

```{r yoy retention, echo=TRUE, eval=FALSE}
reporting.employees <-  reporting.employees %>% mutate(TRUELEAVER = case_when(
  YEAR == "2022" & EXITDATE >= "2022-07-01" & EXITDATE <= Sys.Date()-years(1) ~ 1,
