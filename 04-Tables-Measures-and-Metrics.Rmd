...
IDEA uses [Stream](https://stream.ideapublicschools.org/admin/login) to capture information about enrollment applications, lottery, contracts, and enrollment goals. There are three main tables:
...
A list of the most common codes used is included below:
 ...
 RTTC - Road to and through College | | FE - final exam
 SPA - Spanish | | IA - former interim assessment (final exam - IA4)
  | | BWA - former biweekly assessment
