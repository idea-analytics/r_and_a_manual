...
## Joins
It is possible that the information needed to conduct an analysis resides in more than one table in the data warehouse. To solve for this, a join statement can be used. The appropriate join depends on your data needs and the table structure. In the examples below, four joins will be covered: one inner and three outer joins (left, right, and full). For each join, a matching key (common field between the tables) is identified. Some common keys with IDEA data are StudentNumber and SchoolNumber. 
...
![inner_join(x, y)](img/inner_join.png "visualization of an inner join"){width="600"}
...
![left_join(x, y)](img/left_join.png "visualization of a left join"){width="600"}
...
![right_join(x, y)](img/right_join.png "visualization of a right join"){width="600"}
...
![full_join(x, y)](img/full_join.png "visualization of a full join"){width="600"}
