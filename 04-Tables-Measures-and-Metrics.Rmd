...
There are more columns in this table that could be useful, for example there are columns that indicate if the employee is a First Year Teacher, a First Year employee, or a leaver within the first 90 days of employment.
...
In the reporting.employees table there is a binary column "LEAVERS90D" that is 1 if that staff member left within 90 calendar days of their start date and 0 otherwise. To calculate 90 Day retention, we divide the number of 0's in that column by the total count of first year staff.
