...
persistence_conn <- get_table(.table_name = "PersistenceCode", .database_name = "Persistence",
                                  .schema = "dbo", .server_name = "RGVPDSD-DWPRD1")

#Pull the columns  that you need
persistence_23_24 <- persistence_conn %>%
...
Persistence_Rate_23_23 <- persistence_23_24 %>%
  filter(FDOPCOUNTP == 1) %>%
