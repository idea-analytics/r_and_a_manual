...
When working on R scripts in RStudio, an issue that may occur involves connecting to the servers and dashboards that host ideadata. Warnings or error messages that may appear include: 
Resetting connection to conn_Dashboard
Error: nanodbc/nanodbc.cpp:1021: 08001: [Microsoft][ODBC Driver 17 for SQL Server]Named Pipes Provider: Could not open a connection to SQL Server [53].
