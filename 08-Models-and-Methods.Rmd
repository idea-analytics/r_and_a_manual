...
mean(as.character(df_test$Pclass) != as.character(predicted_class))  # misclassification error
```
...
##### Examples:  
Anomaly detection by identifying data points that are atypical for that type of dataset
One type of anomaly detection is looking for behaviors in the data that deviate from normal patterns in the data, which could expose fraudulent transactions 


##### References
https://cloud.google.com/discover/what-is-unsupervised-learning#section-5
https://learn.g2.com/unsupervised-learning


Graphical Example of Clustering
 + ![This image shows an example of clustering.](img/Clustering.png){width="500"}  
