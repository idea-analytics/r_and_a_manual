...
Primary outcomes will include: student enrollment, student persistence, student academic performance, and employee retention. 

The CSP grant application includes research questions to address the following areas: implementation of the IDEA model, needs and challenges, supports, and sustainability strategies.

Research/Evaluation Question 1: Insert here. 
