...
::: {.hat}
Are you taking notes in a notebook, on a OneNote, or in a Teams chat? Capture the links to all your relevant documents, GitHub repos, notes, pictures, etc. in a relevant task, as a commment, or in a description in the Wrike project! You'll be able to find things you forgot about months later.
:::
...
2. If you used a GRPI/RASI for the project, be sure to update your stakeholders, as well.
  ...
  * Your GRPI/RASI should succintly summarize what you are doing in the project.
