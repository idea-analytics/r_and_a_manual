...
3. Vet the request thoroughly and ask clarifying questions with the requester.

4. If this is an ad-hoc request, keep the request in the original queue and set up tasks (see next section).

5. If this is a medium- to long-term request, then set up a project and related tasks into an appropriate folder:
  * Evaluation Projects
  * Impact Analyses
