...
1. You may see an info box suggesting you can merge your branch.  If so, click on the **Compare & pull request**  button.  If not select your branch and click the Pull Request icon. 
1. If you are able to merge (you'll know) click the **Create pull request** button.
1. Ask someone to review you request (ideally)
1. Click the **Merge pull request button** and confimr the merge. 
1. If you are done with our feature branch feel free to delete it. 
