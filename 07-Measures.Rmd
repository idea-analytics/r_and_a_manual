...
* **Useful Fields:**
  ...
  + **GradeLeve:** character values, two digit grade. Ex. "06"
  ...
  + **LevelII:** 0/1 indicator for the Approaches performance standard
  + **LevelIIFinal:** 0/1 indicator for the Meets performance standard
