...
**Why did we develop a model?** 
After preliminary research and discussion, an existing, comprehensive model for launching and/or scaling new IDEA schools was not found.

* **How did we develop the initial model?** 
We reviewed accessible content online and held a series of weekly discussions focused on CSP.
