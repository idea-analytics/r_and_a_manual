...
The content below is an excerpt from a working document providing information about each component that may be included in an evaluation plan. Because evaluation plans are customized to each project, not all components will be included in every evaluation plan. Generally, the following components are included as standard in most evaluation plans. 
...
Types of ongoing support that will be provided to the program staff over the course of the year. For example, recurring meetings, data requests, etc.
