...
Note that IDEA's brand colors are not completley safe for color blindness.  Here's each palatte with adjustments to check for the predominant types of color blindness in the population:
