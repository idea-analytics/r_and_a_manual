...
```{sql sample_sql_header, eval=FALSE}
/******************************************************************************/
...
There are three general approaches we use for our work for a R project, the more methodical approach is ProjectTemplate which can be found in the project section of this manual. A report style approach which is good for short and quick assignments. A Shiny project which has UI controls and is used for scenarios where the information needs to be absorbed in multiple perspectives.   
